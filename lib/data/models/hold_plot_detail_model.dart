...
class HoldPlotDetail {
  ...
  Plot toPlot({
    ...
    return Plot.fromJson({
      ...
      'width': width,
      'length': length,
      // Prefer each plot's own road widths; booking-level values are fallback only.
      'plot_road_width_front': this.roadWidthFront ?? roadWidthFront,
      'plot_road_width_back': this.roadWidthBack ?? roadWidthBack,
      'plot_road_width_left': this.roadWidthLeft ?? roadWidthLeft,
      'plot_road_width_right': this.roadWidthRight ?? roadWidthRight,
